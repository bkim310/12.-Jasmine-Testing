...
function submitPaymentInfo(evt) {
  ...
  //if curPayment is true, add 1 to payment Id
  if (curPayment) {
    paymentId += 1;

    //allPayments is an object with all previous bills
...
//createCurPayment() will return an object when valid
...
function createCurPayment() {
  ...
  //only works when bill is greater than 0 and tip is equal to or greater than 0
